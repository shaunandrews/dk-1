---
description: Creating new pages, views, and screens across the WordPress ecosystem
globs: ["**/*"]
---
...
```tsx
// repos/calypso/client/my-sites/site-settings/[setting]/index.tsx
...
```
client/my-sites/site-settings/my-feature/
