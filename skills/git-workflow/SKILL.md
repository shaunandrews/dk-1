---
description: Multi-repo git workflows, branch conventions, and PR processes
globs: ["**/*"]
---

# Git Workflow

Multi-repository version control workflows for Design Kit — branch conventions, commit formats, and common operations across dk-1 and sub-repositories.

## CRITICAL: Know Which Repository You're In
...
### Jetpack PR Requirements

Jetpack PRs require changelog entries. Before opening a PR, generate a changelog entry:
...
This launches an interactive prompt to select the project, change type, and write a summary. The generated changelog file must be committed with your PR.
